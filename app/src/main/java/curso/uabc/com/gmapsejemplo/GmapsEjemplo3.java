...
public class GmapsEjemplo3 extends android.support.v4.app.FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gmaps_ejemplo3);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_gmaps_ejemplo3, menu);
        return true;
    }
